<section class="bg-ligth">
    <div class="row g-0 margintop">
        <div class="col-lg-7 d-none d-lg-block mt-0">
        ...
        <div class="col-lg-5 d-flex flex-column align-items-end min-vh-100 mt-0 margen">
            ...
            <div class="px-lg-5 py-lg-4 p-4 w-100 align-self-center">
                ...
                <form>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" class="form-control bg-ligth-x  imgSubir border-0" id="fotoPersonalizados" placeholder="Foto">
